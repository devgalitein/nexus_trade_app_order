					...
					if (
						...
						if (quoteval) {
							...
							let newData = {
								...
								quantity: leg.allow_order * LOT_QUANTITY,
							...
							if (remainingQut) {
								let newDataremain = {
									...
									strike_price: strike_price,
									call_put: leg.call_put,
									quantity: remainingQut * LOT_QUANTITY,
									entry_price: currentRate,
									entry_bn: bnPrice,
									entry_date_time: moment().format("YYYY-MM-DD HH:mm:ss"),
									created_at: moment().format("YYYY-MM-DD"),
...
exports.callSecondQuantity = async (data, remainingQut, current_time) => {
	...
	extraQuantityObject.quantity = remainingQut * LOT_QUANTITY;
...
exports.callFirstQuantity = async (data, remainingQut, current_time) => {
	...
	prepareFirstObject.quantity = data.allow_order * LOT_QUANTITY;
